...
* [ebook-reader-dict](https://github.com/BoboTiG/ebook-reader-dict) ⭐ 944 | 🐛 9 | 🌐 Python | 📅 2026-08-19 - 14 monolingual dictionaries extracted from Wiktionary in several languages.
...
* [Lute](https://github.com/LuteOrg/lute-v3) ⭐ 1,531 | 🐛 213 | 🌐 Python | 📅 2026-07-24 - Learning Using Texts (Lute). A partial rewrite of lwt.
...
* [AnkiDroid](https://github.com/ankidroid/Anki-Android) ⭐ 11,587 | 🐛 377 | 🌐 Kotlin | 📅 2026-08-18 - The free Anki Android client for the most popular flashcard software - the [desktop version](https://apps.ankiweb.net/) is free as well.
* [FSRS4Anki](https://github.com/open-spaced-repetition/fsrs4anki) ⭐ 4,043 | 🐛 8 | 🌐 Jupyter Notebook | 📅 2026-08-14 - An optimized spaced repetition algorithm that should minimize review time.
...
* [LibreTranslate](https://github.com/LibreTranslate/LibreTranslate) ⭐ 16,033 | 🐛 124 | 🌐 Python | 📅 2026-08-10
...
* [Coqui TTS](https://github.com/coqui-ai/TTS) ⭐ 45,916 | 🐛 2 | 🌐 Python | 📅 2024-08-16 - An entirely open source Python library running locally.
* [edge-tts](https://github.com/rany2/edge-tts) ⭐ 11,753 | 🐛 3 | 🌐 Python | 📅 2026-03-22 - A Python library the uses the reverse engineered Text To Speech API of the Edge browser, producing extremely high quality output.

### NLP

* [spaCy](https://github.com/explosion/spaCy) ⭐ 33,830 | 🐛 236 | 🌐 Python | 📅 2026-08-07 - A great library that can do everything: tokenization, lemmatization, named entity recognition, and much more.
